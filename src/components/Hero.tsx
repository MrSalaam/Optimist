...
import { ArrowDown, Sparkles, PenTool, Brush } from "lucide-react";
      ...
      >
        ...
        >
          <div className="relative">
            ...
            <div className="relative bg-background rounded-3xl shadow-2xl overflow-hidden border border-border">
              <motion.img
                src="https://images.unsplash.com/photo-1557862921-37829c790f19?q=80&w=2671&auto=format&fit=crop"
                alt="A professional designer smiling"
            ...
            <motion.div
              ...
              className="absolute -bottom-5 -left-2 sm:-bottom-6 sm:-left-6 bg-background rounded-xl sm:rounded-2xl shadow-xl p-1 sm:p-4 border border-border text-center"
            >
              <div className="text-xs sm:text-2xl font-bold text-foreground">20+</div>
              <div className="text-xs sm:text-sm text-foreground-secondary whitespace-nowrap">Projects Completed</div>
            </motion.div>
            ...
            <motion.div
              ...
              className="absolute -top-4 -right-3 sm:-top-6 sm:-right-6 bg-background rounded-xl sm:rounded-2xl shadow-xl p-1 sm:p-4 border border-border text-center"
            >
              <div className="text-xs sm:text-2xl font-bold text-foreground">3+</div>
              <div className="text-xs sm:text-sm text-foreground-secondary whitespace-nowrap">Years Experience</div>
            </motion.div>
          </div>
        </motion.div>
      </motion.div>
